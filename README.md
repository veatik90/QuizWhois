...
When committing, the message has to be in this form: <type>: <subject>
...
When creating a branch, the branch name has to be in this form: <type>/<subject>

Example: f/add-new-button

types:

bugfix - fixing bug f - everything that's not a bug
